<div class="row">
    ...
    <div class="col-md-3 py-2">
        ...
        <input class="form-control" type="text" name="father" id="father" placeholder="" required
            value="{{ isset($student->father) ? $student->father : old('father') }}">
    </div>

    <div class="col-md-3 py-2">
        <label for="mother">Nome da Mâe</label>
        <input class="form-control" type="text" name="mother" id="mother" placeholder="" required
            value="{{ isset($student->mother) ? $student->mother : old('mother') }}">
    </div>

    <div class="col-md-3 py-2">
        <label for="nBi">Nº do BI</label>
        <input class="form-control" type="text" name="nBi" id="nBi" placeholder="" required
    ...
    <div class="col-md-6 py-2">
        <div class="row">
            <div class="col-6">
                ...
                <input class="form-control" type="text" name="contact" id="contact" placeholder="" required
    ...
    <div class="col-md-3 py-2">
        ...
        <input class="form-control" type="text" name="arquive" id="arquive" placeholder="" required
            value="{{ isset($student->arquive) ? $student->arquive : old('arquive') }}">
    </div>
    <div class="col-md-3 py-2">
        <label for="placeBaptism">Local do Baptismo</label>
        <input class="form-control" type="text" name="placeBaptism" id="placeBaptism" placeholder="" required
            value="{{ isset($student->placeBaptism) ? $student->placeBaptism : old('placeBaptism') }}">
    </div>

    <div class="col-md-3 py-2">
        <label for="confirmLocation">Local da Confirmação(Crisma)</label>
        <input class="form-control" type="text" name="confirmLocation" id="confirmLocation" placeholder="" required
    ...
    <div class="col-md-3 py-2">
        ...
        <select name="fk_parishes_id" class="form-control" aria-label="Default select example">
